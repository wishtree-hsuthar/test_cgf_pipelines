...
const AddMember = () => {
  ...
  const phoneNumberChangeHandler = (e,name,code) => {
    console.log("on number change",e.target.value, "name: ",name, "code", code)
                      ...
                      <Controller
                        ...
                        render={({ field, fieldState: { error } }) => (
                          <Autocomplete
                            ...
                            onBlur={(e) => setValue("parentCompany",e.target.value?.trim())}
                      ...
                      <div className="phone-number-field">
                        <div className="select-field country-code">
                          <Controller
                            ...
                            rules={{
                              validate: () => {
                                if(!watch("countryCode") && watch("phoneNumber")) return "Invalid input"
                              }
                              // validate: () => {
                      ...
                      <div className="salutation-wrap">
                        ...
                        <div className="salutation-inputblk">
                          ...
                          <Input
                            ...
                            onBlur={(e) =>
                                setValue("memberContactFullName", e.target.value?.trim())
                              }
                      ...
                      <div className="phone-number-field">
                        <div className="select-field country-code">
                          <Controller
                            ...
                            rules={{
                              validate: () => {
                                if(!watch("memberContactCountryCode") && watch("memberContactPhoneNuber")) return "Invalid input"
                              }
                            }}
                            render={({ field, fieldState: { error } }) => (
                              <Autocomplete
                                ...
                                renderInput={(params) => (
                                  <TextField
                                    ...
                                    helperText={
                                      error
                                        ? memberHelper.memberContactCountryCode[error?.type]
                                        : " "
                                    }
                                  />
                                )}
                        ...
                        <Input
                          ...
                          onBlur={(e) =>
                            setValue("memberContactPhoneNuber", e.target.value?.trim())
                          }
                          myHelper={memberHelper}
                          rules={{
                            maxLength: 15,
