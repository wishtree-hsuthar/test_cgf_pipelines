        ...
        >
            ...
            <DialogBox
                title={
                    <p>
                        Delete Member "
                        {member?.companyName ? member.companyName : "Member"}"
                    </p>
                }
                info1={
                    <p>
                        We recommend you to replace this member with the new one
                        because deleting all the statistics & records would get
                            ...
                            >
                                <ul className="crud-toggle-list">
                                    <li
                                        ...
                                        onClick={() =>
                                            navigate(
                                                `/users/members/edit-member/${param.id}`
                                            )
                                        }
                                    >
                                        Edit
