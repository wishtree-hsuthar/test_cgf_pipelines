...
const AddSubAdminSchema = yup.object().shape({
  name: yup.string().required("CGF admin name required"),
  email: yup
    .string()
...
const AddSubAdmin = () => {
  ...
  const handleOnSubmit = async (data) => {
    data.countryCode = data.countryCode.slice(data.countryCode.indexOf("+"));
    data = {
      ...data,
  ...
  console.log("phone", watch("phoneNumber"), "code", watch("countryCode"));
  return (
            ...
            <div className="card-wrapper">
              <div className="card-blk flex-between">
                    ...
                    <div className="phone-number-field">
                      <div className="select-field country-code">
                        <Controller
                          ...
                          rules={{
                            validate: () => {
                              if (!watch("countryCode") && watch("phoneNumber"))
                        ...
                        rules={{
                          ...
                          validate: (value) => {
                            if (!watch("phoneNumber") && watch("countryCode"))
                              return "invalid input";
                            if (value && !Number(value)) return "Invalid input";
                          },
                          // validate: (value) => {
                          //     if (
                          //         watch(
                ...
                <div className="card-form-field">
                  <div className="form-group">
                    <label htmlFor="role">
                      Select Role <span className="mandatory">*</span>
                    </label>
