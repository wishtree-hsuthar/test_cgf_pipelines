  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.log("response from sub admin view page fetch api", response);
            ...
            <span className="form-header-right-txt" onClick={handleToggle}>
              ...
              >
                <ul className="crud-toggle-list">
                  {data.map((d, index) => (
                    <li onClick={() => handleOpen(index)} key={index}>
                      {d.action}
                    </li>
                  ))}
                </ul>
            ...
            <div className="card-wrapper">
              <div className="card-blk flex-between">
                    ...
                    <div className="phone-number-field">
                      <div className="select-field country-code">
                        <Autocomplete
                          ...
                          options={countries}
                          autoHighlight
                          getOptionLabel={(country) => country.countryCode}
                          readOnly
                          value={value}
                  ...
                  <div className="form-group">
                    ...
                    <div className="select-field">
                      ...
                      <TextField
                        ...
                        // {...register("phoneNumber")}
                        disabled
                        value={fetchedSubAdminDetails?.subRoleId?.name}
                        // helperText={" "}
                      />
                    </div>
                  </div>
                ...
                <div className="card-form-field">
                  <div className="form-group">
                    <label for="email">
                      Replaced CGF Admin <span className="mandatory">*</span>
                    </label>
                    <TextField
                      className={`input-field `}
                      id="outlined-basic"
