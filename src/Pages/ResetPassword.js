                    ...
                    <div class="login-wrapper">
                        ...
                        <div class="login-rightblk">
                            <div class="login-blk">
                                ...
                                <h2 class="heading1 text-uppercase">Reset Password</h2>
                                <div class="login-form">
                                    <form onSubmit={handleSubmit(submitForm)}>
                                                    ...
                                                    endAdornment={
                                                        <InputAdornment position="end">
                                                            <IconButton
                                                                ...
                                                                className='eye-btn'
                                                            >
                                                                {values.showNewPassword ? <img src={process.env.PUBLIC_URL + '/images/non-visibleicon.png'} alt="" class="img-fluid" /> : <img src={process.env.PUBLIC_URL + '/images/visibleicon.png'} alt="" class="img-fluid" />}
                                                            </IconButton>
                                                        </InputAdornment>
                                                    }
                                                    ...
                                                    endAdornment={
                                                        <InputAdornment position="end">
                                                            <IconButton
                                                                ...
                                                                className='eye-btn'
                                                            >
                                                                {values.showConfirmPassword ? <img src={process.env.PUBLIC_URL + '/images/non-visibleicon.png'} alt="" class="img-fluid" /> : <img src={process.env.PUBLIC_URL + '/images/visibleicon.png'} alt="" class="img-fluid" />}
                                                            </IconButton>
                                                        </InputAdornment>
                                                    }
                                        ...
                                        <div class="form-btn flex-between">
                                            <button type="submit" class="primary-button">Reset</button>
