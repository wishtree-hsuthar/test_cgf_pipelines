...
const DropdownOptionModal = ({
    ...
    useEffect(() => {
        dispatch(
            setOldQuestionnaire(
                questionnaire.sections[sectionIndex].columnValues[columnId]
                    .options
            )
        );
    }, []);
                            ...
                            <div className="popup-content-blk">
                                <div className="custom-list-sect">
                                    ...
                                    {questionnaire?.sections[
                                        sectionIndex
                                    ]?.columnValues[columnId]?.options?.map(
                                        (option, optionIdx) => (
                                            <div
                                                ...
                                                <div className="que-checkbox-wrap">
                                                    <div className="que-checkbox-blk que-dropdown-blk">
                                                        <TextField
                                                            ...
                                                            value={option}
                                                            onChange={(e) =>
                                                                onTableLayoutOptionChangeHandler(
                                                                    e,
                                                                    optionIdx
                                                                )
                                                            }
                                                            onBlur={(e) =>
                                                                onTableLayoutOptionBlurHandler(
                                                                    e,
                                                                    optionIdx
                                                                )
                                                            }
                                                    ...
                                                    {questionnaire?.sections[
                                                        ...
                                                        <div
                                                            ...
                                                            onClick={() =>
                                                                onTableLayoutOptionDeleteHandler(
                                                                    optionIdx
                                                                )
                                                            }
                                                        >
                                    ...
                                    <div className="add-dropdown-btnblk mb-30">
                                        ...
                                        >
                                            <i
                                                onClick={
                                                    onAddOptionClickHandler
                                                }
                                                className="fa fa-plus"
                                            ></i>
                                        </span>{" "}
                                        <span onClick={onAddOptionClickHandler}>
                                            Add Dropdown
                                        </span>
                                    </div>
                                </div>
