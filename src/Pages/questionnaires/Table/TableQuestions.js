...
const TableQuestions = ({
  ...
  const onColumnTogleChangeHandler = (event, columnId) => {
    ...
    tempQuestionnaire.sections[sectionIndex].columnValues[columnId].isRequired =
                          ...
                          <Select
                            ...
                            renderValue={
                              column?.validation !== ""
                                ? undefined
                                : () => (
                                    <Placeholder>Select validator</Placeholder>
                                  )
                            }
                            displayEmpty
                            name="validation"
                      ...
                      {column?.columnType === "dropdown" && (
                        <div className="add-dropdown-btnblk edit-dropdown-btn">
                          <span
                            ...
                            onClick={() => onEditOptionClickHandler(columnId)}
                          >
                    ...
                    <FormGroup>
                      <Stack direction="row" spacing={1} alignItems="center">
                        ...
                        <AntSwitch
                          ...
                          onChange={(e) => onColumnTogleChangeHandler(e,columnId)}
                          // onChange={(e) =>
