...
const SectionContent = ({
  ...
  const validateTableQuestions = (tableCountError, tabIndex) => {
    ...
    let sameColumnTitleNamesInFilteredTableSections = filteredTableSections.map(
      (section) => ({
    ...
    for (
      ...
      if (sectionObject.layout === "table") {
        for (
          ...
          const columnTitle = sectionObject.columnValues[columnIndex].title;
          ...
          for (
            ...
            for (
              let colIndex = 0;
              colIndex < sectionToCheckColumnValues.columnTitles.length;
              colIndex++
            ) {
              const elementToCheck =
                sectionToCheckColumnValues.columnTitles[colIndex];
  ...
  return (
    ...
    <div className="sect-form-card-wrapper">
      ...
      <DialogBox
        ...
        info1={<p> On canceling, newly added details will be discarded.</p>}
